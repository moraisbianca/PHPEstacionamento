    ...
    <div class="container">
        ...
        <form action="/veiculo/save" method="post">
            ...
            <div class="form-check">
                <input name="revisao" class="form-check-input" type="checkbox" <?= ($model->revisao) ? 'checked' : '' ?> value="true">               
            ...
            <div class="form-check">
                <input name ="roubo_furto" class="form-check-input" type="checkbox" <?= ($model->roubo_furto) ? 'checked' : '' ?> value="true" id="check-roubo_furto">
            ...
            <div class="form-check">
                <input name ="aluguel" class="form-check-input" type="checkbox" <?= ($model->aluguel) ? 'checked' : '' ?> value="true" id="check-aluguel">
            ...
            <div class="form-check">
                <input name ="venda" class="form-check-input" type="checkbox" <?= ($model->venda) ? 'checked' : '' ?> value="true" id="check-venda">
            ...
            <div class="form-check">
                <input name ="particular" class="form-check-input" type="checkbox" <?= ($model->particular) ? 'checked' : '' ?> value="true" id="check-particular">
